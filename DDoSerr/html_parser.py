...
def obj_search(url):
    ...
    Надо сделать доп. проверку на наличие "http" в 
    URL-ах (картинки) - частично выполнено.
    ~~~
    """   
    ...
    for line in imgs_presort:
        ...
        """
        #~~~~~
        #Для дописания url к некоторым картинкам, ссылка на которые 
        #начинается не с "http(s)://url", а с слеша после url.
        #!Не работает!
        else:
            line = url + line
            if any([('.gif' in line), ('.png' in line),\
    ...
    """    
    Ищем все URL CSS стилей и записываем список в переменную css.
    ...
    #Надо фильтровать по имени сайта (надо ли?), наличию "http"
    #и расширению ".css".
    ...
    for link in soup.find_all('script'):
     ...
     #Надо фильтровать по расширению ".js", наличию "http" и, 
...
if __name__ == "__main__":
    ...
    #А если возвращать значение, то работает.
    print(content_urls)
